CREATE OR REPLACE TRIGGER TOURNAMENTDBTWOTRIGGER
BEFORE INSERT ON Tournament2
FOR EACH ROW
DECLARE 
DATACOUNT INTEGER;
...
BEGIN
    ...
    VALUES (:NEW.t_id,:NEW.t_descriprion,Round(:NEW.Total_price / 1.3,2),2,SKEY);
    ...
    INSERT INTO DATESTAGE VALUES (:NEW.t_id, DATESK, cast(to_char(:NEW.t_date,'DD') as integer),
        ...
        cast(to_char(:NEW.t_date,'d') as integer),2);
END;