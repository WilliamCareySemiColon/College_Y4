...
//part 2 of the mongo lab - inserting players
db.c16315253_teams.update({name: "Manchester United"}, {$push:{ players:{"p_id": "Keane","goals" : 33,"caps" : 326,  "age": 44}}})
db.c16315253_teams.update({name: "AC Milan"},{$push:{ players:{"p_id": "Kaka","goals" : 53,"caps" : 112,  "age": 32}}})
//find the oldest team
db.c16315253_teams.find().sort({date_founded:1}).limit(1).pretty()
//add three goals to each
db.teams.update({ name:"Real Madrid", "players.p_id": "Bale" },{ $inc:{"players.$.goal":3} })
db.teams.update({ name:"Real Madrid", "players.p_id": "Ronaldo" },{ $inc:{"players.$.goal":3}})
db.teams.update({ name:"Real Madrid", "players.p_id": "Benzema" },{ $inc:{"players.$.goal":3}})
db.teams.update({ name:"Real Madrid", "players.p_id": "Marcelo" },{ $inc:{"players.$.goal":3}})